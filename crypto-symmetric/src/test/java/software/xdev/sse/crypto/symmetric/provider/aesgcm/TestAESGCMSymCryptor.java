...
class TestAESGCMSymCryptor
{
	...
	static void setUp()
	{
		cryptor = new AESGCMSymCryptorProvider(
			new byte[]{82, 97, 110, 100, 111, 109, 73, 110, 105, 116, 73, 86},
			16)
			.create(new byte[]{54, 52, 50, 56, 97, 56, 102, 98, 98, 98, 48, 101, 49, 50, 48, 53});
	}
	
	// sepp
	static final byte[] DECRYPTED = new byte[]{115, 101, 112, 112};
	static final byte[] ENCRYPTED = new byte[]{
		-97, 97, -88, 103, -3, 104, -79, 35, 76, 96, 40, 25, 47, -19, 1, -81, 105, -104, -32, -22};
