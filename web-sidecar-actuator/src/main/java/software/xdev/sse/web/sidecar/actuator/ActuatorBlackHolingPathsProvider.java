...
{
	protected final WebEndpointProperties actuatorWebEndpointProperties;
	
	public ActuatorBlackHolingPathsProvider(final WebEndpointProperties actuatorWebEndpointProperties)
	{
		this.actuatorWebEndpointProperties = actuatorWebEndpointProperties;
	}
