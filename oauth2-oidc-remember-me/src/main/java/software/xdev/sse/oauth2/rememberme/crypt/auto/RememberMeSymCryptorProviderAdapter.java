...
public class RememberMeSymCryptorProviderAdapter implements RememberMeSymCryptorProvider
{
	...
	public RememberMeSymCryptorProviderAdapter(final SymCryptorProvider provider)
	{
	...
	@Override
	public byte[] createSecretKeyFrom(final Random random)
	{
		return this.provider.createSecretKeyFrom(random);
	}
	
	@Override
	public RememberMeSymCryptor create(final byte[] secretKey)
	{
		return new RememberMeSymCryptorAdapter(this.provider.create(secretKey));
	}
}
