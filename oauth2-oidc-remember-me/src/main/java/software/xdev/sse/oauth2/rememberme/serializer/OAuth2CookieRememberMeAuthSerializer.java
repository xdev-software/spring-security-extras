...
{
	String serialize(final OAuth2AuthenticationToken token, final OAuth2AuthorizedClient client);
	
	OAuth2AuthContainer deserialize(
		final String json,
		final Function<String, ClientRegistration> clientRegistrationResolver);
	
	interface OAuth2AuthContainer
	{
