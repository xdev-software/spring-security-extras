...
public class AESGCMSymCryptorProviderInstantiator
	extends SymCryptorProviderInstantiator<AESGCMSymCryptorProviderConfig>
{
	...
	@Override
	public SymCryptorProvider instantiate(final AESGCMSymCryptorProviderConfig config)
	{
		return new AESGCMSymCryptorProvider(
			config.getInitVector().getBytes(StandardCharsets.UTF_8),
			config.getSecretKeyLength());
	}
}
